...
@NonNullApi
public class KmmKtorProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KmmKtorProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
